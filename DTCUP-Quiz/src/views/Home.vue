...
import { shouldSyncBundledBank } from '../utils/bankSync'
...
onMounted(() => {
  if (shouldSyncBundledBank({
    currentBankName: store.currentBank,
    currentQuestionCount: store.totalQuestions,
    bundledBank: sampleBank
  })) {
